...
export default function AuthForm({ mode, onSubmit, loading, error }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-black p-8 rounded-2xl shadow-lg w-full max-w-md space-y-7 border border-gray-800">
            ...
            {mode === 'signup' && (
                <div className="relative">
                    ...
                    <div className="flex items-center border border-gray-700 rounded-lg px-3 py-2 bg-black focus-within:ring-2 focus-within:ring-blue-500">
                        ...
                        <input
                            ...
                            className="input-field flex-1 bg-black border-none text-white focus:ring-0 text-base placeholder-gray-500"
                            required
            ...
            <button
                type="submit"
                className="w-full py-3 text-lg font-semibold rounded-lg shadow-md mt-2 bg-gray-900 text-white border border-gray-700 hover:bg-gray-800 transition-colors disabled:opacity-60"
                disabled={loading}
            >
